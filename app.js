...
function cargarMunicipios() {
  ...
  if (!selCiudad) return;
  var munis = {
    'Antioquia':['Medellín','Envigado','Sabaneta','Itagüí','Bello','La Estrella','Caldas','Rionegro','Guarne','El Retiro','La Ceja','Barbosa','Girardota','Copacabana','San Antonio de Prado','Santa Elena','San Cristóbal','Palmitas','Alto Palmas','Marinilla','El Carmen de Viboral','Apartadó','Turbo','Caucasia','Santa Fe de Antioquia','Otro municipio de Antioquia'],
    'Bogotá D.C.':['Bogotá D.C.'],
    'Valle del Cauca':['Cali','Palmira','Buenaventura','Tuluá','Buga','Cartago','Yumbo','Jamundí','Otro municipio del Valle'],
    'Atlántico':['Barranquilla','Soledad','Malambo','Sabanalarga','Otro municipio del Atlántico'],
    'Bolívar':['Cartagena','Magangué','Mompox','Otro municipio de Bolívar'],
    'Santander':['Bucaramanga','Floridablanca','Girón','Piedecuesta','Barrancabermeja','Otro municipio de Santander'],
    'Cundinamarca':['Bogotá D.C.','Soacha','Fusagasugá','Facatativá','Zipaquirá','Chía','Cajicá','Otro municipio de Cundinamarca'],
    'Córdoba':['Montería','Cereté','Lorica','Sahagún','Otro municipio de Córdoba'],
    'Nariño':['Pasto','Tumaco','Ipiales','Otro municipio de Nariño'],
    'Tolima':['Ibagué','Espinal','Melgar','Honda','Otro municipio del Tolima'],
    'Huila':['Neiva','Pitalito','Garzón','La Plata','Otro municipio del Huila'],
    'Cauca':['Popayán','Santander de Quilichao','Otro municipio del Cauca'],
    'Meta':['Villavicencio','Acacías','Granada','Otro municipio del Meta'],
    'Risaralda':['Pereira','Dosquebradas','Santa Rosa de Cabal','Otro municipio de Risaralda'],
    'Quindío':['Armenia','Calarcá','Montenegro','Otro municipio del Quindío'],
    'Caldas':['Manizales','La Dorada','Chinchiná','Otro municipio de Caldas'],
    'Boyacá':['Tunja','Duitama','Sogamoso','Chiquinquirá','Otro municipio de Boyacá'],
    'Norte de Santander':['Cúcuta','Ocaña','Pamplona','Otro municipio de Norte de Santander'],
    'Cesar':['Valledupar','Aguachica','Otro municipio del Cesar'],
    'La Guajira':['Riohacha','Maicao','Otro municipio de La Guajira'],
    'Magdalena':['Santa Marta','Ciénaga','Fundación','Otro municipio del Magdalena'],
    'Sucre':['Sincelejo','Corozal','Otro municipio de Sucre'],
    'Caquetá':['Florencia','Otro municipio de Caquetá'],
    'Casanare':['Yopal','Otro municipio de Casanare'],
    'Arauca':['Arauca','Otro municipio de Arauca'],
    'Putumayo':['Mocoa','Puerto Asís','Otro municipio de Putumayo'],
    'Chocó':['Quibdó','Otro municipio de Chocó'],
    'Vichada':['Puerto Carreño','Otro municipio de Vichada'],
    'Guainía':['Inírida','Otro municipio de Guainía'],
    'Guaviare':['San José del Guaviare','Otro municipio de Guaviare'],
    'Vaupés':['Mitú','Otro municipio de Vaupés'],
    'Amazonas':['Leticia','Otro municipio de Amazonas'],
